...
public class LinearRegressionExample3Region {

    public static void main(String[] args) {
        // Create Linear Regression model
        // We'll use it for classification by predicting one-hot encoded class vectors
        ...
        // One-hot labels: N samples, each with 3 outputs (treating as classification)
        double[][] Y = {
                // Class 0 -> [1,0,0]
                {1, 0, 0},
                {1, 0, 0},
        ...
        System.out.println("Training Linear Regression for classification...");
        System.out.println("Note: Linear regression is NOT designed for classification,");
        System.out.println("      but we can use it by predicting one-hot vectors.");
        ...
        SwingUtilities.invokeLater(() -> {
            JFrame f = new JFrame("Linear Regression - 3-Class Decision Boundary");
